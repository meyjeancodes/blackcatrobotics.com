...
const PLATFORMS: PlatformProfile[] = [
  ...
  },
  {
    ...
    category: "humanoid",
    description: "Open-source DIY humanoid kit by Menlo Research (asimovinc). 1.2 m, 35 kg, 25+2 DOF. Full CAD, electrical schematics, and MuJoCo simulation models publicly available under CERN-OHL-S-2.0.",
    specs: [
      { label: "Height", value: "1.2 m" },
      { label: "Weight", value: "35 kg" },
      { label: "DOF", value: "25 actuated + 2 passive" },
      { label: "Legs", value: "6 DOF x 2 + toe x 2" },
      { label: "Arms", value: "5 DOF x 2" },
      { label: "Torso", value: "1 DOF waist yaw" },
      { label: "Material", value: "7075 aluminum + PA12 nylon" },
      { label: "Battery", value: "LiPo" },
      { label: "Compute", value: "RPi 5 + Radxa CM5" },
      { label: "Cost", value: "$15,000 (DIY kit)" },
    ],
    tlmRanges: { healthScoreMin: 50, healthScoreMax: 80, batteryPctMin: 10, batteryPctMax: 90, motorTempMin: 30, motorTempMax: 70 },
    failureSignatures: [
      { id: "can-bus-fault", name: "CAN Bus Fault", severity: "critical", description: "Joint actuators dropping out mid-motion" },
      { id: "tmc2209-overtemp", name: "Motor Driver Overtemp", severity: "warning", description: "TMC2209 driver >60°C" },
      { id: "aluminum-fatigue", name: "Structural Fatigue", severity: "warning", description: "Cracking at thigh/torso brackets" },
      { id: "nylon-degradation", name: "Nylon Part Degradation", severity: "info", description: "PA12 covers deforming or cracking" },
      { id: "imu-drift", name: "IMU Drift", severity: "warning", description: "Balance issues after mechanical work" },
    ],
    maintenanceCta: "View assembly manual",
    manualUrl: "https://docs.menlo.ai/asimov",
    diagramUrl: "https://github.com/menloresearch/asimov-1",
  },
  {
    id: "dji-agras-t60",
    name: "DJI Agras T60",
  ...
  // ── New Acquire additions (homepage) ──────────────────────────────────────
  {
    id: "uworld-u1-lite",
    name: "UBTECH UWORLD U1 Lite",
    manufacturer: "UBTECH Robotics",
    category: "humanoid",
    description: "Entry humanoid in the UWORLD U1 line. Balanced height and payload for research, education, and light enterprise trials. MSRP $16,500.",
    specs: [
      { label: "Height", value: "1.3 m" },
      { label: "Payload", value: "15 kg" },
      { label: "Runtime", value: "2 h" },
      { label: "SDK", value: "ROS 2" },
      { label: "MSRP", value: "$16,500" },
    ],
    tlmRanges: { healthScoreMin: 70, healthScoreMax: 95, batteryPctMin: 15, batteryPctMax: 92, motorTempMin: 35, motorTempMax: 68 },
    failureSignatures: [
      { id: "actuator-overheat", name: "Actuator Overheat", severity: "critical", description: "Joint temp > 70°C sustained" },
    ...
    manualUrl: "https://www.ubtrobot.com",
    diagramUrl: "https://www.ubtrobot.com",
    badge: "Acquire",
  },
  {
    id: "uworld-u1-pro",
    name: "UBTECH UWORLD U1 Pro",
    manufacturer: "UBTECH Robotics",
    category: "humanoid",
    description: "Mid-tier UWORLD U1 with expanded payload and longer runtime. Dexterous hands and unrestricted developer access for AI training. MSRP $23,400.",
    specs: [
      { label: "Height", value: "1.5 m" },
      { label: "Payload", value: "20 kg" },
      { label: "Runtime", value: "2.5 h" },
      { label: "SDK", value: "ROS 2" },
      { label: "MSRP", value: "$23,400" },
    ],
    tlmRanges: { healthScoreMin: 68, healthScoreMax: 94, batteryPctMin: 12, batteryPctMax: 91, motorTempMin: 38, motorTempMax: 70 },
    failureSignatures: [
      { id: "actuator-overheat", name: "Actuator Overheat", severity: "critical", description: "Joint temp > 72°C sustained" },
      { id: "joint-backlash", name: "Joint Backlash", severity: "warning", description: "Position error > 3mm" },
      { id: "battery-critical", name: "Battery Critical", severity: "critical", description: "SOC < 15% during operation" },
    ],
    maintenanceCta: "Request quote",
  ...
  {
    id: "uworld-u1-ultra",
    name: "UBTECH UWORLD U1 Ultra",
    manufacturer: "UBTECH Robotics",
    category: "humanoid",
    description: "Flagship UWORLD U1. Industrial-grade full-size humanoid with maximum payload, extended runtime, and the full UWORLD perception stack. MSRP from $121,400.",
    specs: [
      { label: "Height", value: "1.6 m" },
      { label: "Payload", value: "30 kg" },
      { label: "Runtime", value: "3 h" },
      { label: "SDK", value: "ROS 2" },
      { label: "MSRP", value: "from $121,400" },
    ],
    tlmRanges: { healthScoreMin: 66, healthScoreMax: 93, batteryPctMin: 10, batteryPctMax: 90, motorTempMin: 40, motorTempMax: 74 },
    failureSignatures: [
      { id: "actuator-overheat", name: "Actuator Overheat", severity: "critical", description: "Joint temp > 75°C sustained" },
      { id: "joint-backlash", name: "Joint Backlash", severity: "warning", description: "Position error > 4mm" },
      { id: "battery-critical", name: "Battery Critical", severity: "critical", description: "SOC < 15% during operation" },
    ],
    maintenanceCta: "Request quote",
    manualUrl: "https://www.ubtrobot.com",
  ...
  },
  {
    id: "robo-1",
    name: "ROBO-1",
    manufacturer: "ROBO Robotics",
    category: "industrial",
    description: "6-DOF robot arm with gripper, built for teachable, repeatable automation. Train a policy once on demonstration data, deploy to any ROBO-1 in the fleet. Native LeRobot support, MuJoCo digital twin, Agent API.",
    specs: [
      { label: "DOF", value: "6 + gripper" },
      { label: "Reach", value: "700 mm" },
      { label: "Payload", value: "1 kg" },
      { label: "Weight", value: "<3 kg" },
      { label: "API", value: "Agent API + LeRobot" },
    ],
    tlmRanges: { healthScoreMin: 74, healthScoreMax: 97, batteryPctMin: 20, batteryPctMax: 100, motorTempMin: 30, motorTempMax: 60 },
    failureSignatures: [
      { id: "joint-backlash", name: "Joint Backlash", severity: "warning", description: "EEF position error > 2mm on repetitive trajectory" },
      { id: "actuator-overheat", name: "Servo Overheat", severity: "warning", description: "Joint servo > 70°C during sustained high-torque moves" },
    ],
    ...
    diagramUrl: "https://robo.inc",
    badge: "New",
  },

  // ── Aftermarket H1 parts (real checkout in /store) ────────────────────────
  {
    id: "h1-knee-act",
    name: "H1 Knee Actuator",
    manufacturer: "Unitree Robotics",
    category: "industrial",
    description: "Genuine replacement knee actuator module for the Unitree H1. Direct-fit, factory-calibrated. Replace at 73% wear before failure.",
    specs: [
    ...
    tlmRanges: { healthScoreMin: 80, healthScoreMax: 99, batteryPctMin: 100, batteryPctMax: 100, motorTempMin: 30, motorTempMax: 60 },
    failureSignatures: [
      { id: "knee-actuator-wear", name: "Knee Actuator Wear", severity: "warning", description: "Knee position error > 4mm indicates reducer wear — replace at 73% wear" },
    ],
  ...
  },
  {
    ...
    manufacturer: "Unitree Robotics",
    category: "industrial",
    description: "864Wh main power pack for the Unitree H1. CATL cells, factory-matched BMS. Swap at 800 cycles or on TechMedix health alert.",
    specs: [
  ...
  },
  {
    ...
    manufacturer: "Unitree Robotics",
    category: "industrial",
    description: "Genuine shoulder actuator assembly. CubeMars drive unit, factory-torque-matched. Replace on TechMedix shoulder-R wear alert.",
    specs: [
      { label: "Fit", value: "H1 / H1-2" },
    ...
    tlmRanges: { healthScoreMin: 80, healthScoreMax: 99, batteryPctMin: 100, batteryPctMax: 100, motorTempMin: 30, motorTempMax: 60 },
    failureSignatures: [
      { id: "shoulder-actuator-wear", name: "Shoulder Actuator Wear", severity: "warning", description: "Shoulder position error > 3mm — replace on wear alert" },
    ],
    maintenanceCta: "Order part",
    manualUrl: "https://unitree.com",
    diagramUrl: "https://unitree.com",
  ...
  },
  {
    ...
    manufacturer: "Unitree Robotics",
    category: "industrial",
    description: "Replacement dexterous end-effector with integrated tactile sensing. Sharpa module, multi-DOF. Calibrate via TechMedix after install.",
    specs: [
    ...
    tlmRanges: { healthScoreMin: 80, healthScoreMax: 99, batteryPctMin: 100, batteryPctMax: 100, motorTempMin: 30, motorTempMax: 60 },
    failureSignatures: [
      { id: "hand-calibration-drift", name: "Hand Calibration Drift", severity: "warning", description: "Finger position error > 2mm — recalibrate after install" },
    ],
    maintenanceCta: "Order part",
    manualUrl: "https://unitree.com",
    diagramUrl: "https://unitree.com",
