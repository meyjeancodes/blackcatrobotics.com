...
const PLATFORMS: PlatformProfile[] = [
  ...
  },
  {
    ...
    manufacturer: "Unitree Robotics",
    category: "humanoid",
    description: "Full-size humanoid at ~178cm with 29 DOF. Hydraulic actuation on legs, electric on arms. Extended range and payload vs H1. Official TechMedix partner platform with full URDF model.",
    urdfPath: "/robots/unitree-h2/H2_dae.urdf",
    urdfBadge: "Official URDF",
    specs: [
      { label: "Height", value: "~178 cm" },
      { label: "Total DOF", value: "29" },
      { label: "Leg Actuation", value: "Hydraulic" },
      { label: "Arm DOF", value: "7 per arm" },
      { label: "Payload", value: "~10 kg" },
      { label: "Battery", value: "~3.5h operation" },
    ],
    tlmRanges: { healthScoreMin: 67, healthScoreMax: 95, batteryPctMin: 12, batteryPctMax: 92, motorTempMin: 32, motorTempMax: 82 },
    failureSignatures: [
      { id: "hydraulic-leak", name: "Hydraulic Leak", severity: "critical", description: "Leg actuator pressure drop > 10% indicates seal failure — stop operation immediately" },
      { id: "actuator-overheat", name: "Actuator Overheat", severity: "critical", description: "Leg hydraulic temp > 80°C during sustained gait" },
      { id: "joint-backlash", name: "Joint Backlash", severity: "warning", description: "Leg joint position error > 25mm" },
      { id: "battery-critical", name: "Battery Critical", severity: "critical", description: "SOC < 15% during active task" },
    ],
    maintenanceCta: "Schedule H2 service",
    manualUrl: "https://support.unitree.com/home/en/H2_developer",
    diagramUrl: "https://github.com/unitreerobotics/unitree_ros/tree/master/robots/h2_description",
  },
  {
    id: "figure-02",
    name: "Figure 02",
