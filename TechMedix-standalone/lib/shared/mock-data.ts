...
export const robots: Robot[] = [
  {
    ...
    location: "BMW Plant Spartanburg, SC",
    region: "Southeast",
    status: "warning",
    healthScore: 68,
  ...
  },
  {
    ...
    location: "Lubbock County Farm Grid, TX",
    region: "Texas",
    status: "service",
    healthScore: 44,
  ...
  },
  {
    ...
    location: "Mercedes Prototype Cell, AL",
    region: "Southeast",
    status: "online",
    healthScore: 87,
...
export const systemNodes: SystemNode[] = [
  { id: "node_atlas_7f4a", name: "Atlas-7F4A", type: "robot", status: "warning", last_seen: "2026-03-19T09:15:00.000Z", metadata: { location: "BMW Plant Spartanburg, SC", platform: "Boston Dynamics Atlas Gen 2", health: 68 } },
  { id: "node_unitree_g1", name: "Unitree-G1-11", type: "robot", status: "online", last_seen: "2026-03-19T09:13:00.000Z", metadata: { location: "Austin Test Lab, TX", platform: "Unitree G1 EDU", health: 92 } },
  { id: "node_dji_t50", name: "Agras-T50-03", type: "robot", status: "maintenance", last_seen: "2026-03-19T08:58:00.000Z", metadata: { location: "Lubbock County Farm Grid, TX", platform: "DJI Agras T50", health: 44 } },
  { id: "node_figure_02", name: "Figure-02-09", type: "robot", status: "online", last_seen: "2026-03-19T09:11:00.000Z", metadata: { location: "Mercedes Prototype Cell, AL", platform: "Figure 02", health: 87 } },
...
export const auditLogs: AuditLog[] = [
  ...
  { id: "log_002", action: "technician_assigned", user: "megan@blackcatrobotics.com", role: "admin", timestamp: "2026-03-19T09:12:00.000Z", resource: "wo_001", detail: "Assigned Priya Shah to work order wo_001" },
...
export const serviceEventTemplates: ServiceEventTemplate[] = [
  ...
  { message: "Technician en route to BMW Plant Spartanburg", severity: "info" },
  { message: "Service completed successfully — Atlas-7F4A", severity: "success" },
  ...
  { message: "Technician dispatched to Austin Test Lab", severity: "info" },
  ...
  { message: "Technician assigned — Priya Shah → WO-0044", severity: "info" },
  ...
  { message: "Technician dispatched to Mercedes Prototype Cell", severity: "info" },
