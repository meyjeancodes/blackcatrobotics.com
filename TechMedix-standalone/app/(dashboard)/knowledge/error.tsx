...
export default function KnowledgeError({
  ...
  useEffect(() => {
    ...
    console.error("Knowledge section error:", error);
  }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <p className="text-sm text-theme-55 max-w-md mb-6">
        An error occurred while loading the Knowledge section. This could be a temporary issue.
        Try refreshing or navigate back to the Knowledge Hub.
      </p>
      {error.digest && (
