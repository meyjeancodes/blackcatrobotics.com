    ...
    <div className="space-y-8">
      ...
      <section className="grid gap-4 sm:grid-cols-3">
        {[
          ...
          <div key={m.label} className="panel-elevated p-5 flex flex-col gap-2">
            ...
            <p className="font-header text-3xl leading-none tracking-[-0.04em] text-black">
              {m.value}
            </p>
          </div>
        ))}
      ...
      <section>
        <div className="mb-5">
          ...
          <h2 className="mt-2 font-header text-2xl leading-tight text-black">
            Facility Health
          </h2>
        </div>
            ...
            >
              <div className="flex items-start justify-between gap-2">
                <div>
                  ...
                  <p className="mt-0.5 font-ui text-[0.60rem] uppercase tracking-[0.18em] text-black/40">
                    {facility.location}
                  </p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <p className="font-ui text-[0.57rem] uppercase tracking-[0.16em] text-black/35">Robots</p>
                  <p className="mt-0.5 font-header text-2xl leading-none text-black">{facility.robotCount}</p>
                </div>
                <div>
                  <p className="font-ui text-[0.57rem] uppercase tracking-[0.16em] text-black/35">Avg Health</p>
                  <p className={`mt-0.5 font-header text-2xl leading-none ${HEALTH_COLOR(facility.avgHealth)}`}>
                    {facility.avgHealth}%
                  </p>
                </div>
                <div>
                  <p className="font-ui text-[0.57rem] uppercase tracking-[0.16em] text-black/35">Uptime SLA</p>
                  <p className="mt-0.5 text-sm font-semibold text-black">{facility.uptimeSla}%</p>
                </div>
                <div>
                  <p className="font-ui text-[0.57rem] uppercase tracking-[0.16em] text-black/35">Alerts</p>
              ...
              <Link
                ...
                className="mt-auto inline-flex items-center justify-center rounded-full border border-black/[0.12] px-4 py-2 font-ui text-[0.62rem] uppercase tracking-[0.18em] font-semibold text-black/60 transition hover:bg-black/[0.04] hover:text-black"
              >
                View Fleet
              </Link>
            </div>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {platforms.map((platform) => (
            ...
            >
              <div className="flex items-start justify-between gap-2">
                <div>
                  <p className="font-ui text-[0.58rem] uppercase tracking-[0.16em] text-black/38">
                    {platform.manufacturer}
                  </p>
                  <h3 className="mt-1 font-header text-xl leading-tight text-black">{platform.name}</h3>
                </div>
                <div className="rounded-xl bg-black/[0.05] p-2.5 text-black/35 shrink-0">
                  <Shield size={16} />
                </div>
              </div>
              <p className="text-xs leading-relaxed text-black/52">{platform.description}</p>
      ...
      <section className="panel-dark p-8">
        <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 font-ui text-[0.65rem] uppercase tracking-[0.18em] font-semibold text-black transition hover:bg-white/90 shrink-0"
          >
            Learn More
          </a>
        </div>
